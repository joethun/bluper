...
import { crashZoomEffect, pulseEffect, slowZoomEffect } from "./motion";
import { chromaticAberrationEffect, vhsEffect } from "./tape";
import { colorShiftEffect, filmicEffect } from "./color";
...
const groups: ReadonlyArray<{
	...
	{
		title: "Motion",
		definitions: [pulseEffect, crashZoomEffect, slowZoomEffect],
	},
	{
		title: "Looks",
		definitions: [vhsEffect, filmicEffect, colorShiftEffect],
	},
	{
		title: "Optics",
		definitions: [
