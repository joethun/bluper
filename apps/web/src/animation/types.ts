...
/**
 * Every property path the editor recognises. Type-only: the runtime check
 * lives in `editor-core::animation::path`.
 */
...
type DiscreteAnimationKey = BaseAnimationKeyframe<DiscreteValue>;
...
interface ScalarGraphChannel extends ScalarGraphChannelTarget {
