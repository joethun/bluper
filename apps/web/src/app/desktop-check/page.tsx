 ...
 * results to stdout.
 *
 * In the browser build there is nothing here to test.
 */
		...
		return (
			<main className="mx-auto max-w-2xl p-8">
				...
				<p className="text-muted-foreground mt-2 text-sm">
					These checks cover the desktop shell&apos;s filesystem-backed
					storage. The browser build stores media in OPFS instead, under the
					origin&apos;s quota, so there is nothing here to run.
				</p>
			</main>
		);
	}
