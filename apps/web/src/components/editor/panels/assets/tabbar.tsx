		...
		<div className="relative flex">
			...
			>
				{TAB_KEYS.map((tabKey) => {
					...
					return (
						// This rail and the properties panel's tab rail are the same
						// control on opposite sides of the editor, so they share one
						// tooltip treatment: the default variant, plain label text, no
