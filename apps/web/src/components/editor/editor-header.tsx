...
import { CommandIcon, LogOutIcon, MoonIcon, SunIcon } from "lucide-react";
...
function EditableProjectName() {
	...
	return (
		<input
			...
			className={cn(
				// `transition-colors duration-150` matches the base of `buttonVariants`
				// so this reads as one of the header's buttons on hover instead of
				// snapping while everything beside it eases.
				"text-base h-8 px-2 py-1 rounded-sm bg-transparent outline-none cursor-pointer transition-colors duration-150 hover:bg-accent hover:text-accent-foreground",
