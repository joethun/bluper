...
import { computeTextMaskParamUpdateValue as _computeTextMaskParamUpdateValue } from "bluper-wasm";
...
function computeTextMaskParamUpdate({
	...
	return _computeTextMaskParamUpdateValue({
		handleId,
		startParams,
		deltaX,
		deltaY,
